    ...
    <div className="inner-row">
      ...
      <div className="row-right">
        ...
        <div className="grouped-actions">
          ...
          >
            {isPending ? <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg> : "✓"}
          </button>
        </div>
      </div>
    </div>
